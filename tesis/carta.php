...
<body>
        ...
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="personalOp.php" >Personal operativo</a></li>   
                    <li><a href="carta.php" >Cartas</a></li>              
                </ul>
    ...
    <div class="action">
        ...
        <input type="button" onclick="listarCartas();" class="btn-flat" id="mostrar" value="Mostrar" ></input>
                ...
                <!-- right column -->
                <div id="tablaCarta" class="col-md-7 column pull-right">
                    <div id="cargando"></div>
                    <div id="content">
        <h1 style="text-align: center;">Cartas</h1>
        <hr>
        <div class="row">
            <div class="container">
                <div align="right">
                    <a href="exportar.php"><button type="button" class="btn btn-light">Exportar registro</button></a>
                </div>
            <div class="container">
                    <?php
    ...
    // Consulta SQL para seleccionar datos de la tabla (por ejemplo, 'usuarios')
    $sql = "SELECT fecha, remitente,motivo FROM cartas";
