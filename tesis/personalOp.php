        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row form-wrapper">
                ...
                <div id="miPagina" class="col-md-5 column">
                    ...
                    <form method="POST" >
                        <h1>Registro de Personal Operativo</h1><hr>
                        <div class="field-box">
                            <label>Grado:</label>
                            <div class="col-md-7">
                                <input name="grado" id="grado" class="form-control" required autofocus type="text">
                            </div>                            
                        </div>
                        <div class="field-box">
                            <label>Nombre:</label>
                        ...
                        <div class="action">
                            ...
                            <input type="button" onclick="listarOperativos();"  class="btn-flat" id="mostrar" value="Mostrar" ></input>
                        </div> 
                ...
                <!-- right column -->
                <div id="tablaOp" class="col-md-7 column pull-right">
                    <div id="cargando"></div>
                </div>
            </div>
        </div>
